...
valueMatrix::Subprocessor::Subprocessor(int index)
{
	this->index = index;
}

double valueMatrix::Subprocessor::add(double operand1, double operand2)
{
	return operand1 + operand2;
}

double valueMatrix::Subprocessor::substract(double operand1, double operand2)
{
	return operand1 - operand2;
}

double valueMatrix::Subprocessor::multiply(double operand1, double operand2)
{
	return operand1 * operand2;
}

double valueMatrix::Subprocessor::max(double operand1, double operand2)
{
	return operand1 >= operand2 ? operand1 : operand2;
}

double valueMatrix::Subprocessor::min(double operand1, double operand2)
{
	return operand1 <= operand2 ? operand1 : operand2;
}

double valueMatrix::Subprocessor::run(const valueMatrix::operationName operation, double operand1, double operand2)
{
	double result = 0;
...
void valueMatrix::generateTwoDimentionalMatrix(TwoDimentionalMatrix* matrix)
{
...
void valueMatrix::switchSubprocessorIndex(int* index)
{
...
void valueMatrix::updateTime(operationName operation)
{
	switch (operation)
	{
	case ADD:
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, TwoDimentionalMatrix* matrix1, TwoDimentionalMatrix* matrix2)
{
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, TwoDimentionalMatrix* matrix, const double digit)
{
	int subprocessorIndex = 0;
	TriDimentionalMatrix* resultMatrix = new TriDimentionalMatrix(p, q, m);
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, TriDimentionalMatrix* matrix, const double digit)
{
	int subprocessorIndex = 0;
	TriDimentionalMatrix* resultMatrix = new TriDimentionalMatrix(p, q, m);
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, TriDimentionalMatrix* matrix1, TwoDimentionalMatrix* matrix2)
{
	int subprocessorIndex = 0;
	TriDimentionalMatrix* resultMatrix = new TriDimentionalMatrix(p, q, m);
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, const double digit, TwoDimentionalMatrix* matrix)
{
	int subprocessorIndex = 0;
	TriDimentionalMatrix* resultMatrix = new TriDimentionalMatrix(p, q, m);
...
TriDimentionalMatrix* valueMatrix::processTriDim(const operationName operation, TriDimentionalMatrix* matrix1, TriDimentionalMatrix* matrix2)
{
	int subprocessorIndex = 0;
	TriDimentionalMatrix* resultMatrix = new TriDimentionalMatrix(p, q, m);
...
TwoDimentionalMatrix* valueMatrix::processTwoDim(const operationName operation, TriDimentionalMatrix* matrix)
{
	int subprocessorIndex = 0;
...
TwoDimentionalMatrix* valueMatrix::processTwoDim(const operationName operation, TriDimentionalMatrix* matrix1, TriDimentionalMatrix* matrix2)
{
	int subprocessorIndex = 0;
	TwoDimentionalMatrix* resultMatrix = new TwoDimentionalMatrix(p, q);
...
TwoDimentionalMatrix* valueMatrix::processTwoDim(const operationName operation, TwoDimentionalMatrix* matrix, const double digit)
{
	int subprocessorIndex = 0;
	TwoDimentionalMatrix* resultMatrix = new TwoDimentionalMatrix(p, q);
...
TwoDimentionalMatrix* valueMatrix::processTwoDim(const operationName operation, TwoDimentionalMatrix* matrix1, TwoDimentionalMatrix* matrix2)
{
	int subprocessorIndex = 0;
	TwoDimentionalMatrix* resultMatrix = new TwoDimentionalMatrix(p, q);
...
TwoDimentionalMatrix* valueMatrix::processTwoDim(const operationName operation, const double digit, TwoDimentionalMatrix* matrix)
{
	int subprocessorIndex = 0;
	TwoDimentionalMatrix* resultMatrix = new TwoDimentionalMatrix(p, q);
...
void valueMatrix::equalMatrixes(TwoDimentionalMatrix* matrix1, TwoDimentionalMatrix* matrix2)
{
	for (int i = 0; i < p; i++)
	{
		for (int j = 0; j < q; j++)
...
void valueMatrix::equalMatrixes(TriDimentionalMatrix* matrix1, TriDimentionalMatrix* matrix2)
{
	for (int i = 0; i < p; i++)
	{
		for (int j = 0; j < q; j++)
...
void valueMatrix::calculateDMatrix()
{
	D = processTriDim(MULTIPLY_AB, A, B);
}

void valueMatrix::calculateFMatrix()
{
...
void valueMatrix::calculateCMatrix()
{
